...
<MobileElementEntity>
   ...
   <name>Masukkan Nomor HP Field</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Masukkan Nomor HP' or . = 'Masukkan Nomor HP')]</locator>
